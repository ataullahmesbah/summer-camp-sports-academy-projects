...
const InstructorOwnClass = () => {
    ...
    const url = `https://final-project-server-side-ataullahmesbah.vercel.app/classes?email=${user?.email}`;
    ...
    const handleDelete = id => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`https://final-project-server-side-ataullahmesbah.vercel.app/classes/${id}`, {
                    method: 'DELETE',
                })
                    .then(res => res.json())
                    .then(data => {
