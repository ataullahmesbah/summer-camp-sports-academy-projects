...
<div id="slide1" className="carousel-item relative w-full md:mt-24 mt-[120px]">
  ...
  <div className="absolute flex rounded-xl items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
    ...
    <div className='text-white space-y-7 pl-20 w-1/2'>
      <h2 className='text-6xl font-bold'>Welcome to Elite Athlete Arena</h2>
      <p>Take Your Performance to the Next Level at Elite Athlete Arena! Unleash Your Potential at Elite Athlete Arena!</p>
      <div className="flex gap-2">

        <button className="btn btn-outline btn-secondary">Unlock Your Potential</button>
...
<div id="slide2" className="carousel-item relative w-full md:mt-24 mt-[120px]">
  ...
  <div className="absolute flex rounded-xl items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
    <div className='text-white space-y-7 pl-20 w-1/2'>
      <h2 className='text-6xl font-bold md:text-3xl'>Peak Athletic Academy</h2>
      <p>Reach the pinnacle of athleticism through comprehensive training.</p>
      <div className="flex gap-2">
