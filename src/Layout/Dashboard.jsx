...
import { FaAlignLeft, FaBookmark, FaPlusCircle } from "react-icons/fa";
                ...
                <ul className="menu p-4 w-80 h-full bg-blue-900 ">
                    ...
                    {userRole === 'instructor' && (
                        <>
                            ...
                            <li><NavLink to='/dashboard/addclasses' className='font-semibold text-xl text-white'><FaPlusCircle /> Add Classes</NavLink></li>
