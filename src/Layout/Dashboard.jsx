                ...
                <ul className="menu p-4 w-80 h-full bg-blue-900 ">
                    ...
                    {userRole === 'student' && (
                        <>
                            <div className="mx-4 mt-3 flex gap-3">
                                <img className="w-8 h-8" src={icon} alt="" />
                                <li className="text-3xl mb-8 text-gray-200 font-bold font-serif">Elite Athlete <br /> Arena</li>
                            </div>
                            <li><NavLink to='/dashboard/studenthome' className='font-bold text-xl text-white'><FaUserGraduate className="text-gray-400" /> Student Home</NavLink></li>
                            <li><NavLink to='/dashboard/enrollclasses' className='font-semibold text-xl text-white'><FaBookOpen className="text-gray-400" /> Enroll Class</NavLink></li>
                            <li><NavLink to='/dashboard/myclasses' className='font-semibold text-xl text-white'><FaShoppingCart className="text-gray-400" /> My Booking Class</NavLink></li>
                            <li><NavLink to='/dashboard/paymenthistory' className='font-semibold text-xl text-white'><FaDollarSign className="text-gray-400" /> Payment History</NavLink></li>
                        </>
                    )}
